...
% Using Zhanjiang 90km area to verify slant range systematic error
...
fprintf('  2. GCP data folder: ZQ/GCP/\n');
...
pathView = 'D:/a_workStation_Space//0_a_Data_Center_RD/几何定标/肇庆定位/GCP/';
