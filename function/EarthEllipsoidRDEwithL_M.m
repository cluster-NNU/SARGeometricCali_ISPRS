function [latT,lonT,hpT] = EarthEllipsoidRDEwithL_M(HInit, VENU,AirplanePosition,initLoc,h0,R,sv)
%  EARTHELLIPSOIDRDEWITHL_M Solve RDE equations using LM algorithm
% 
% Using Earth ellipsoid, solving equations without normalization
