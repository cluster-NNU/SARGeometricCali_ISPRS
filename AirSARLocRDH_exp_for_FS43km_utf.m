...
fprintf('  2. Check point folder: FSA/CP/\n');
...
% radarPath= 'D:/0_a_Data_Center_RD/佛山43km定位b/temp_radarParam.txt';
% 
% readSARInfo(radarPath)
...
%% 15 GCPs
% % RD 
% CaliParam_SQRD.range = 64.80;
% CaliParam_SQRD.azimuth = 3.75; 

% % VC
% CaliParam_VC.range = 64.76;
% CaliParam_VC.azimuth = 2.65; 

% % our method
% CaliParam_our.range = 64.80;
% CaliParam_our.azimuth = -5.17; 

%% 5 GCPs
CaliParam_SQRD.range = 67.32;
CaliParam_SQRD.azimuth = -1.31; 

% VC
CaliParam_VC.range = 67.32;
CaliParam_VC.azimuth = 0.87; 

% our method
CaliParam_our.range = 67.32;
CaliParam_our.azimuth = -8.35; 
...
for i = 1:length(PicNumList)
    ...
    pathView = 'D:/a_workStation_Space//0_a_Data_Center_RD/几何定标/佛山43km定位b/CP/';
    for gcp = 1:gcpR
