...
% RD
CaliParam_SQRD.range = 87.09;
CaliParam_SQRD.azimuth = 16.24; 

% VC
CaliParam_VC.range = 87.08;
CaliParam_VC.azimuth = 0.10; 

% our method
CaliParam_our.range = 87.08;
CaliParam_our.azimuth = -3.35; 
...
for i = 1:length(PicNumList)
    ...
    pathView = 'D:/a_workStation_Space//0_a_Data_Center_RD/几何定标/肇庆定位/CP/';
    for gcp = 1:gcpR
