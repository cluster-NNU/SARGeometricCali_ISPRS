...
% 保存结果到MAT文件
filePath = 'SlantRangeErrorU_simulation_results_velocityTest.mat';
...
print('SARPositioningUncertainty_vs_SlantRange_velocityTest','-dpdf','-bestfit')
